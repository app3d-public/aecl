...
namespace aecl::image
{
    ...
    namespace bmp
    {
        struct Params : OIIOParams
        {
            ...
            Params(const umbf::Image2D &image, f32 dpi = 72.0f, bool dither = false)
                : OIIOParams(
                      {FormatFlagBits::bit8 | FormatFlagBits::alpha,
                       {umbf::ImageFormat::Type::uint, umbf::ImageFormat::Type::none, umbf::ImageFormat::Type::none}}),
                  image(image),
                  dpi(dpi),
                  dither(dither)
            {
        ...
        AECL_EXPORT bool save(const acul::string &path, Params &bp);
    } // namespace bmp
    ...
    namespace gif
    {
        struct Params : OIIOParams
        {
            ...
            Params(const acul::vector<umbf::Image2D> &images, bool interlacing = false, int loops = 0, int fps = 0)
                : OIIOParams(
                      {FormatFlagBits::bit8 | FormatFlagBits::multilayer,
                       {umbf::ImageFormat::Type::uint, umbf::ImageFormat::Type::none, umbf::ImageFormat::Type::none}}),
                  images(images),
        ...
        AECL_EXPORT bool save(const acul::string &path, Params &gp);
    } // namespace gif
    ...
    namespace hdr
    {
        ...
        AECL_EXPORT bool save(const acul::string &path, Params &hp);
    } // namespace hdr
    ...
    namespace jpeg
    {
        ...
        AECL_EXPORT bool save(const acul::string &path, Params &jp);
    } // namespace jpeg
    ...
    namespace openexr
    {
        ...
        AECL_EXPORT bool save(const acul::string &path, Params &op, u8 dst_bit);
    } // namespace openexr
    namespace png
    {
        struct Params : OIIOParams
            ...
            Params(const umbf::Image2D &image, f32 dpi = 72.0f, bool dither = false, int compression = 6,
                ...
                : OIIOParams(
                      {FormatFlagBits::bit8 | FormatFlagBits::bit16 | FormatFlagBits::alpha,
                       {umbf::ImageFormat::Type::uint, umbf::ImageFormat::Type::uint, umbf::ImageFormat::Type::none}}),
                  image(image),
                  dpi(dpi),
                  dither(dither),
                  compression(compression),
        ...
        AECL_EXPORT bool save(const acul::string &path, Params &pp, u8 dst_bit);
    } // namespace png
    ...
    namespace pnm
    {
        ...
        AECL_EXPORT bool save(const acul::string &path, Params &pp);
    } // namespace pnm
    ...
    namespace targa
    {
        ...
        AECL_EXPORT bool save(const acul::string &path, Params &tp);
    } // namespace targa
    ...
    namespace tiff
    {
        ...
        AECL_EXPORT bool save(const acul::string &path, Params &tp, u8 dst_bit);
    } // namespace tiff
    ...
    namespace webp
    {
        ...
        AECL_EXPORT bool save(const acul::string &path, Params &wp);
    } // namespace webp
    ...
    namespace umbf
    {
        ...
        AECL_EXPORT bool save(const acul::string &path, Params &up);
    } // namespace umbf
