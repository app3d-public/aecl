...
namespace aecl::image
{
    ...
    public:
         ...
         */
        virtual bool load(const acul::string &path, acul::vector<::umbf::Image2D> &images) = 0;
    ...
    public:
         ...
         * @return True if the image is successfully loaded, false otherwise.
         */
        virtual bool load(const acul::string &path, acul::vector<::umbf::Image2D> &images) override;
    ...
    public:
        OpenEXRLoader()
            : OIIOLoader(
                  {FormatFlagBits::bit16 | FormatFlagBits::bit32 | FormatFlagBits::alpha | FormatFlagBits::multilayer,
                   {::umbf::ImageFormat::Type::none, ::umbf::ImageFormat::Type::sfloat,
                    ::umbf::ImageFormat::Type::sfloat}})
        {
        }
    ...
    public:
        TIFFLoader()
            : OIIOLoader({FormatFlagBits::bit8 | FormatFlagBits::bit16 | FormatFlagBits::bit32 | FormatFlagBits::alpha |
    ...
    AECL_EXPORT ILoader *get_importer_by_path(const acul::string &path);
} // namespace aecl::image